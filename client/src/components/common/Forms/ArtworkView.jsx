...

{
    /* <div className="group relative">
        <p
          className="text-neutral-300 text-sm px-2 py-1 select-none cursor-pointer hover:underline truncate w-40"
          onClick={() => {
        ...
        <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-hover:delay-800 delay-0 absolute w-42 bg-neutral-800 text-neutral-300 rounded z-200">
          {artwork.title.en}
        </div>
